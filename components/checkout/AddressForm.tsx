...
import { AddressDetailsFragment, CheckoutError, CountryCode } from '@/generated/graphql'
...
export function AddressForm({ existingAddressData, toggleEdit, updateAddressMutation }: AddressFormProps) {
  const {
        ...
        <div className="col-span-full">
          ...
          <div className="mt-1">
            <input
              type="text"
              id="phone"
              className="w-full rounded-md border-gray-300 text-base shadow-sm"
              spellCheck={false}
        ...
        <div className="col-span-full sm:col-span-6">
          ...
          <div className="mt-1">
            <input
              type="text"
              id="province"
              className="block w-full rounded-md border-gray-300 text-base shadow-sm focus:border-indigo-500 focus:ring-indigo-500"
              spellCheck={false}
